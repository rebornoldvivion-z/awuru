...
Engine **7.2.0**. Not a broker. Not a 24/7 daemon.

Trend continuation requires directional structure (HH/HL or LH/LL). EMA/ADX cannot override expanding HH+LL. Gold is a core market via labeled PAXG proxy.
